...
function GetinTouch() {
  ...
  function validateForm() {
    ...
    if (!formData.role.trim()) {
      newErrors.role = "Please specify the role you are hiring for.";
    }

    if (
      formData.positions !== "" &&
      (isNaN(formData.positions) || Number(formData.positions) < 1)
    ) {
  ...
  return (
    <div className="py-7 md:py-10 lg:py-15 flex text-white overflow-hidden">
      <div
        ref={leftRef}
      ...
      >
        <div className="text-center flex flex-col gap-2 md:gap-3 lg:gap-4">
          ...
          <p className="content !font-[300]">
            Tell us your requirements and we will connect you with the right
            talent.
          </p>
        </div>
        ...
        <form
          ...
          className="content flex flex-col lg:gap-6 md:gap-4 gap-3"
        >
          <div className="flex lg:flex-row md:flex-row flex-col gap-3 md:gap-7 lg:gap-9">
            <div className="flex flex-col gap-1 w-full lg:w-1/2">
              ...
              <input
                ...
                className={`small-text w-full h-12 rounded-lg px-3 outline-none focus:outline-none border ${errors.name ? "border-red-500" : "border-[#E9EAEB]"}`}
              />
              {errors.name && (
          ...
          <div className="flex lg:flex-row md:flex-row flex-col gap-3 md:gap-7 lg:gap-9">
            <div className="flex flex-col gap-1 w-full lg:w-1/2">
              ...
              <input
                ...
                onChange={handleChange}
                className={`small-text w-full h-12 rounded-lg px-3 outline-none focus:outline-none border ${errors.email ? "border-red-500" : "border-[#E9EAEB]"}`}
              />
              {errors.email && (
          ...
          <div className="flex lg:flex-row md:flex-row flex-col gap-3 md:gap-7 lg:gap-9">
            <div className="flex flex-col gap-1 w-full lg:w-1/2">
              <label
                ...
                htmlFor="role"
              >
                Role Hiring For <span className="text-red-500">*</span>
              </label>
              <input
                id="role"
                name="role"
                ...
                value={formData.role}
                onChange={handleChange}
                className={`small-text w-full h-12 rounded-lg px-3 outline-none focus:outline-none border ${errors.role ? "border-red-500" : "border-[#E9EAEB]"}`}
              />
              {errors.role && (
            ...
            <div className="flex flex-col gap-1 w-full lg:w-1/2">
              ...
              <input
                ...
                onChange={handleChange}
                className={`small-text w-full h-12 rounded-lg px-3 outline-none focus:outline-none border ${errors.positions ? "border-red-500" : "border-[#E9EAEB]"}`}
              />
              {errors.positions && (
