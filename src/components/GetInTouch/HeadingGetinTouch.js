...
export default function HeadingGetinTouch() {
    return (
        ...
        <header className="relative flex justify-center items-center bg-gradient-to-b from-[#0277BD] to-[#0E6497] md:py-12 py-10 mb-[28px]   md:mb-[40px] lg:mb-[60px] rounded-b-2xl overflow-hidden" aria-label="Submit CV header">
            <img
            ...
            <img
                ...
                aria-hidden="true"
            />
            <h1 className="heading-bold text-white">
                Get In Touch
            </h1>
        </header>
