              ...
              <div className="w-full max-w-5xl">
                <div className="flex flex-col lg:flex-row items-stretch gap-2 lg:gap-0
                  ...
                  <div className="flex flex-col sm:flex-row flex-1 min-w-0 lg:h-16 items-center justify-between gap-1">
                    ...
                    />
                    <select className="w-full sm:flex-[1.5] lg:flex-[1.5] lg:min-w-[200px] px-4 py-3 lg:py-4 bg-transparent text-white outline-none border-b sm:border-b-0 sm:border-r border-white ">
