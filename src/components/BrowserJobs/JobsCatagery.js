...
const categories = [
  ...
  { title: "Building Material", jobs: 1126, img: "/images/broserJobs/building.svg" },
  { title: "FMCG", jobs: 1126, img: "/images/broserJobs/fmcg.svg" },
  { title: "BFSI", jobs: 1126, img: "/images/broserJobs/bfsi.svg" },
  { title: "Mani Actuating", jobs: 1126, img: "/images/broserJobs/settings.svg" },
];
...
function AnimatedCard({ cat, visible, delay }) {
  return (
    <div
      ...
      className={`w-full max-w-lg bg-white border border-blue-400 rounded-2xl p-6 sm:p-8 text-center shadow-[0px_4px_4px_0px_#00000014] transition-all duration-700 ${
        visible
          ? "opacity-100 translate-y-0"
