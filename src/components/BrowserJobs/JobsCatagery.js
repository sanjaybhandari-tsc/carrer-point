...
export default function JobsCategory() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="heading-bold lg:mb-10">
          Browse Jobs by <span className="text-blue-500">Category</span>
        </h2>

        <p className="mt-3 sm:mt-4 content  text-black lg:mb-20  ">
...
function AnimatedCard({ cat, visible, delay }) {
  return (
    ...
    >
      ...
      <h3 className="subheading-semibold ">
        {cat.title}
      </h3>
      <p className="mt-1 sm:mt-2 content-semibold leading-[100%]">
        {cat.jobs} Jobs
      </p>
    </div>
  );
