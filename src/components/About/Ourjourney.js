            ...
            <div ref={bottomRef} className={`space-y-10 transition-all duration-700 ease-out
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    ...
                    <div className="md:w-[80%] flex items-start flex-col">
                        <h3 className=" md:text-2xl sm:text-xl  mb-3 font-roboto font-bold text-[32px] lg:text-[32px] leading-[150%] tracking-normal">
                            The Foundation
                        </h3>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2011</p>
                    </div>
                    ...
                    <div className="md:w-[80%] flex items-start flex-col">
                        ...
                        <p className="text-[#000000]  md:text-base font-roboto font-normal text-[20px]  lg:text-[20px] leading-[150%] tracking-normal">
                            The company expanded to a 350 sq. ft office with a growing team of 10 recruiters. Client partnerships increased to 7 insurance clients, and annual revenue <span className='font-roboto font-semibold text-[20px] leading-[150%] tracking-normal text-[#0277BD]'>reached ₹11 lakh</span>, reflecting strong early growth.
                        </p>
                    </div>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2013</p>
                    </div>
                    ...
                    <div className="md:w-[80%] flex items-start flex-col">
                        ...
                        <div>
                            <p className="text-[#000000]  md:text-base font-roboto font-normal text-[20px]  lg:text-[20px] leading-[150%] tracking-normal">
                                ...
                                <span className='font-roboto font-semibold text-[20px] leading-[150%] tracking-normal text-[#0277BD]'>₹25 lakh</span>in revenue.
                            </p>
                        </div>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2015</p>
                    </div>
                    ...
                    <div className="md:w-[80%] flex items-start flex-col">
                        ...
                        <div>
                            <p className="text-[#000000]  md:text-base font-roboto font-normal text-[20px]  lg:text-[20px] leading-[150%] tracking-normal">
                                The company  <span className='font-roboto font-semibold text-[20px] leading-[150%] tracking-normal text-[#0277BD]'>launched Excel Financial Solution</span>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2017</p>
                    </div>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl   text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2019</p>
                    </div>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2021</p>
                    </div>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2023</p>
                    </div>
                    ...
                    <div className="md:w-[80%] flex items-start flex-col">
                        ...
                        <div>
                            <p className="text-[#000000]  md:text-base font-roboto font-normal text-[20px]  lg:text-[20px] leading-[150%] tracking-normal">
                                With a strong workforce of 30 recruiters, 10 freelancers, and 15 loan collection executives, the company continued serving 40+ industry clients and achieved a major milestone by <span className='font-roboto font-semibold text-[20px] leading-[150%] tracking-normal text-[#0277BD]'>reaching ₹1 crore</span>in revenue.
                            </p>
                        </div>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2024</p>
                    </div>
                ...
                <div className="border-b border-gray-300 pb-8 flex items-start justify-between   flex-col md:flex-row gap-6">
                    <div className="md:w-[20%] ">
                        <p className='text-4xl md:text-5xl  text-black  font-montserrat font-black lg:text-[60px] leading-none tracking-normal'>2025</p>
                    </div>
                    ...
                    <div className="md:w-[80%] flex items-start flex-col">
                        ...
                        <div>
                            <p className="text-[#000000]  md:text-base font-roboto font-normal text-[20px]  lg:text-[20px] leading-[150%] tracking-normal">
                                ...
                                <span className='font-roboto font-semibold text-[20px] leading-[150%] tracking-normal text-[#0277BD]'>ISO 1002:2018 certification</span>, reflecting its continued commitment to maintaining high standards in recruitment services and client satisfaction.
                            </p>
                        </div>
