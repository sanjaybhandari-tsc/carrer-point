        ...
        <div className='bg-[linear-gradient(180deg,rgba(250,250,250,0.25)_0%,rgba(3,155,230,0.15)_50%,rgba(250,250,250,0.25)_100%)] overflow-hidden'>
            <div className="w-full px-4 sm:px-6 md:px-16 lg:px-30 lg:py-20 py-16">
                ...
                <div className="space-y-10">
                    ...
                    {/* 2009 */}
                    <div className="border-b border-gray-300 pb-8 flex flex-col md:flex-row items-start gap-4 md:gap-6 pe-10">
                        ...
                        <div className="journey-item w-full md:w-[80%] flex flex-col opacity-0 translate-x-10 transition-all duration-500 ease-out gap-3.75">
                            <h3 className="heading-bold leading-[150%] tracking-normal">
                                The Foundation
                            </h3>
                    ...
                    {/* 2025 */}
                    <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6 pe-10 ">
                        <div className="journey-item md:w-[20%] opacity-0 -translate-x-10 transition-all duration-500 ease-out">
