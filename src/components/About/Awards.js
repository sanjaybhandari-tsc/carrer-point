    ...
    >
      <div className="mx-auto p-6 md:p-10 rounded-lg lg:px-30 lg:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-strich mb-5">
          <div
            className={`flex gap-6 flex-col order-1 transition-all duration-700 lg:max-h-60  xl:max-h-100 overflow-y-auto pr-2 no-scrollbar ${
              visible
          ...
          <div
            className={`w-full relative rounded-lg overflow-hidden order-2 transition-all duration-700 ${
              visible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-16"
            }`}
