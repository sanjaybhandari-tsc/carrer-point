...
export default function BuildingCarrers() {
  ...
  return (
    <div
      ref={ref}
      className="w-full px-6 sm:px-10 md:px-16 lg:px-20 xl:px-25 
                 py-10 sm:py-14 md:py-20 lg:py-24 xl:py-30 
                 m-auto bg-white overflow-hidden"
    >
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-15">
        ...
        <div
          className={`w-full lg:w-[60%] flex flex-col gap-4 sm:gap-5 md:gap-6 text-[#333333]
