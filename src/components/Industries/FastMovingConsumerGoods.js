      ...
      <div className="max-w-6xl mx-auto flex flex-col xl:flex-row items-center gap-10 md:gap-12">
        ...
        >
          ...
          <p className="leading-relaxed mb-4 text-gray-700">
            The Fast Moving Consumer Goods (FMCG) sector operates in a
            fast-paced and highly competitive environment where efficiency,
            strong distribution networks, and market understanding are critical.
            Companies in this industry require skilled professionals who can
            respond quickly to changing consumer demands and evolving retail
            trends.
          </p>

          <p className="leading-relaxed text-gray-700">
            We provide FMCG recruitment and staffing solutions, helping
            organizations hire experienced professionals in sales, supply chain
            management, and distribution operations. Our focus is on building
            high-performing teams that drive sales growth, optimize product
            movement, and improve overall business performance across
